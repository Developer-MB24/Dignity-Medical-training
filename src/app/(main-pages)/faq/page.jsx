      ...
      <div className="bg-goldlight min-h-screen py-10 px-5 ">
        ...
        <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-md p-6">
          ...
          <Accordion open={open === 2} icon={<Icon id={2} open={open} />}>
            ...
            <AccordionBody className="text-lg text-gray-700">
              Yes, our courses are accredited and recognized due to their
              quality and relevance in the healthcare industry.
            </AccordionBody>
          </Accordion>
          ...
          <Accordion open={open === 3} icon={<Icon id={3} open={open} />}>
            ...
            <AccordionBody className="text-lg text-gray-700">
              If you are experiencing trouble accessing your account, please
              reach out to our customer service for help.
            </AccordionBody>
          </Accordion>
          ...
          <Accordion open={open === 4} icon={<Icon id={4} open={open} />}>
            ...
            <AccordionBody className="text-lg text-gray-700">
              ...
              in-office skills/written tests online (self-paced), and blended
              CPR and First Aid courses, as well as Abuse Neglect Exploitation
              training via Zoom.
            </AccordionBody>
          </Accordion>
          ...
          <Accordion open={open === 5} icon={<Icon id={5} open={open} />}>
            ...
            <AccordionBody className="text-lg text-gray-700">
              Yes, we do offer private classes. Please contact customer service
          ...
          <Accordion open={open === 8} icon={<Icon id={8} open={open} />}>
            ...
            <AccordionBody className="text-lg text-gray-700">
              No, only registered individuals are permitted to attend our
              classes.
            </AccordionBody>
          </Accordion>
        </div>
