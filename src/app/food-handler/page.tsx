      ...
      <div className="bg-gray-100 min-h-screen py-10 px-5">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white shadow-lg rounded-lg p-6">
            <img
              src="/assets/courses/course-27.jpg"
              alt="Course Preview"
...
//                 <ul className="list-disc pl-5 space-y-2">
//                   <li>
//                     Course Fully Updated: Dive into animated videos, 50 writing
//                     assignments, and 60 interactive quizzes.
//                   </li>
//                   <li>
//                     Advanced Copywriting Skills: Persuasive techniques and
//                     overcoming objections.
//                   </li>
//                   <li>
//                     ChatGPT for E-Commerce & Local SEO: Crafting Google My
//                     Business descriptions.
//                   </li>
//                   <li>
//                     Content Creation with Expert Guidance: Walkthroughs from an
//                     experienced copywriter.
//                   </li>
//                 </ul>
//                 <ul className="list-disc pl-5 space-y-2">
//                   <li>
//                     Mastering ChatGPT for Content Creation: SEO, social media,
//                     and complete blog concepts.
//                   </li>
//                   <li>
//                     Effective Influencer Outreach: Engage influencers and
//                     bloggers.
//                   </li>
//                   <li>
//                     Access Pro Content Creation Templates: Emails, blogs, and
//                     sales letters.
//                   </li>
//                   <li>
//                     Essential Copywriting for Beginners: Psychology behind
//                     persuasion.
//                   </li>
//                 </ul>
//               </div>
