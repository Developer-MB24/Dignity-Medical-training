      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        <div className="relative">
          <Image
            ...
            alt={
              course[0].paypal_order_id
                ? `Course image for ${course[0].paypal_order_id}`
                : "Course image"
            }
            width={1200}
            height={500}
          ...
          <div className="absolute top-4 left-4 text-white bg-black bg-opacity-50 px-3 py-1 rounded-lg">
            <p className="text-xl font-semibold">{course[0].paypal_order_id}</p>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Purchase Id: {course[0].paypal_order_id}
          </p>
          <p className="text-sm text-gray-600 mb-2">
            Instructor: {course[0].instructor_first_name}{" "}
            {course[0].instructor_last_name}
          </p>
          <p className="text-sm text-gray-600 mb-4">
          ...
          <div className="flex justify-between items-center">
            {/* Join Class Button with id appended to URL */}
            <Link
              target="_blank"
              href={`${course[0].url}/${course[0].course_id}`}
