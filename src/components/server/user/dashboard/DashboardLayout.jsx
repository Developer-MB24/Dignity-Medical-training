  ...
  return (
    <>
      ...
      <section className="flex">
          ...
          >
            ...
            <ul className="flex flex-col space-y-4 font-medium">
              <Link href="/user/courses">
                <li
                  className={clsx("aside-li", {
                    "bg-primarygold rounded-md text-goldlight font-bold":
              ...
              <Link href="/user/purchase-history">
                <li
                  className={clsx("aside-li", {
                    "bg-primarygold rounded-md text-goldlight font-bold":
                      pathname === "/user/purchase-history",
                  })}
                >
                  <FaHistory />
        ...
        {/* Main Content */}
        <div
          className={clsx("m-4 flex-grow transition-all duration-300", {
