...
const CartPanel = () => {
  const { cartItems, removeFromCart, toggleCart, totalPrice } = useCart(); // Access cart state and functions
    ...
    <div className="fixed right-0 top-0 h-full w-full sm:w-1/5 bg-white shadow-lg p-4 z-[101] flex flex-col">
      ...
      {cartItems.length > 0 && (
        <div className="border-t pt-4">
          ...
          <button
            className="bg-goldlight hover:bg-primarygold text-white px-4 py-2 rounded w-full mt-2"
